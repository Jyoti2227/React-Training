...
class LionClassBasedComponent extends React.Component{
    render(){
        return(
            <>
                <h3>Lion</h3>
                <p>
                    ...
                    although some lions scavenge when opportunities occur and have been known to hunt 
                    humans, 
                    lions typically do not actively seek out and prey on humans.
                </p>
            </>
        )
    }
...
export default LionClassBasedComponent;